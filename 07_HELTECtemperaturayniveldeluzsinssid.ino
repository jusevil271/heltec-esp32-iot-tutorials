...
void loop()
{
  if (WiFi.status() == WL_CONNECTED)
  {
    ...
    factory_display.drawString(0,16,"Temp:");
    factory_display.drawString(42,16,String(temperatura,1)+" C");

    factory_display.drawString(0,30,"Luz:");
    factory_display.drawString(42,30,String(luz));

    // Barra de luz
    int anchoBarra = map(luz,0,4095,0,128);

    factory_display.drawRect(0,52,128,10);
    factory_display.fillRect(0,52,anchoBarra,10);
